...
### 출처의무
본 저장소의 모든 소스코드, 문서 및 그 파생물은 MIT License에 따라 자유롭게 사용할 수 있습니다.
단, 다음의 조건을 반드시 준수해야 합니다:

본 프로젝트에서 제공한 코드 또는 내용을 사용하는 모든 파생 프로젝트, 상용/비상용 서비스 및 문서에는 반드시 다음 출처 고지 문구를 포함해야 합니다.
```
Copyright (c) 2025 (https://github.com/GyeongjinLee/RAG_Learning)
MIT 라이선스로 공개한 원본 자료를 기반으로 구성되었습니다.
```
